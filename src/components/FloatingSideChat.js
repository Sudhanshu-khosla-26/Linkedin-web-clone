...
const FloatingSideChat = ({name, userPhoto, id, setChatid}) => {
  
  // useFloatingSideChatEffect(() => {
    // const payload = {
      //     user: props.User,
      // }   
    ...
    <>
        <Container>
          {/* <Link to={`/messaging/thread/`}>
            ...
            <div className="sidechat" onClick={() => {
                  setChatid(id);
                  }}>
...
const mapStateTOProps = (state) => {
  ...
  export default connect(mapStateTOProps, mapDispatchToProps)(FloatingSideChat);